  ...
  return (
    <div className="min-h-screen bg-transparent flex flex-col items-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full max-w-5xl mb-8 text-center">
        ...
        <h1 className="text-4xl font-extrabold text-black dark:text-white tracking-tight">ARC Automation</h1>
          ...
          <DropZone 
            title={
              <div className="flex justify-between items-center">
                ...
                <a href="/sample_master.csv" download className="text-xs text-gray-500 dark:text-gray-400 hover:text-black dark:hover:text-white underline font-normal">
                  Download Sample CSV
                </a>
              </div>
            }
